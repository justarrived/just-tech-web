    ...
    <Content>
      <article class="markdown-body entry-content p-5" itemprop="text">
        ...
        <ul>
          ...
          <li>
            <p>
              Eliminate environment inconsistencies and the "works on my
              machine" problem by packaging the application, configs and
              dependencies into an isolated container.
            </p>
          </li>
        </ul>
        <h2>
        ...
        <p>
          Get down and dirty with the first steps of Docker by following the
          guide below.
        </p>
        <ul>
          <li>
        ...
        <p>
          Examples are all good and well, but nother beats the hands on
          experience of having run your own application in Docker.
        </p>
        <ul>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              <a
                href="https://www.docker.com/products/docker-hub"
                rel="nofollow"
              >
                Docker Hub
              </a>
